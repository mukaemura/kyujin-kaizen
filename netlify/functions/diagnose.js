...
採点基準：
①タイトル訴求（0〜25点）：職種明確か/具体性(数字・内容)あるか/ベネフィットあるか/誰向けか明確か/検索ワードあるか（各5点）。減点：抽象ワードのみ-5、35文字以上-3、内容曖昧-5
...
評価ランク：80〜100=非常に良い（応募獲得期待大）、65〜79=良い（軽微な改善で伸びる）、50〜64=改善余地あり、35〜49=要改善、〜34=危険（応募来ない可能性高）
改善優先度：どれか1つでも12点以下=高、複数が13〜17点=中、全て18点以上=低

以下のJSONのみ返答：
{"scores":{"title":数値,"clarity":数値,"differentiation":数値,"motivation":数値},"total":合計,"rank":"ランク文字列","priority":"高or中or低","issues":["課題1","課題2","課題3"],"proposals":["改善提案1","改善提案2","改善提案3"],"titleSuggestions":["タイトル案1","タイトル案2","タイトル案3"]}
